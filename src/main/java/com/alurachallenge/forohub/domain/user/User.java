...
public class User implements UserDetails {
    ...
    public User(RegistroUserDTO registroUsuarioDTO) {
        this.name = registroUsuarioDTO.name();
        this.email = registroUsuarioDTO.email();
        this.password = registroUsuarioDTO.password();
    }

    public User(RegistroUserDTO registroUsuarioDTO, BCryptPasswordEncoder bCryptPasswordEncoder) {
        this.name = registroUsuarioDTO.name();
    ...
    public void UserUpdateDTO(UserUpdateDTO actualizacionUsuarioDTO) {
