...
import com.alurachallenge.forohub.infra.security.*;
...
public class AutenticacionController {
    ...
    @PostMapping
    @Transactional
    public ResponseEntity usuarioAutenticacion(@RequestBody @Valid UserDTO usuarioDTO) {
        ...
        var token = tokenService.generarToken((User) autenticacionUsuario.getPrincipal());
